package com.learning.springcloud.websocket;
...
public class WebSocketServer {
    ...
    private static void sendMsg(String toUserId) throws IOException {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    webSocketMap.get(toUserId).sendMessage("hello web-socket-1!!!");
                    webSocketMap.get(toUserId).sendMessage("hello web-socket-2!!!");
                } catch (IOException e) {
                    e.printStackTrace();
